              ...
              document.querySelectorAll('.work-title').forEach(title => {
                  ...
                  titleChildNodes.forEach(node => {
                      if (node.nodeType === 3) {
                          ...
                          chars.forEach(char => {
                              if (char === ' ') {
                                  title.appendChild(document.createTextNode('\u00A0')); // Use non-breaking space like 
the original code
                              } else if (char.trim() !== '') {
                                  const span = document.createElement('span');
                  ...
                  title.addEventListener('mouseenter', () => {
                      hoverTimeouts.forEach(clearTimeout); // Clear any reversing timeouts
                      hoverTimeouts = [];
                  ...
                  title.addEventListener('mouseleave', () => {
                      hoverTimeouts.forEach(clearTimeout); // Clear any forward timeouts
                      hoverTimeouts = [];
